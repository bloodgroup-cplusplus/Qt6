...
//https://stackoverflow.com/questions/11170564/is-there-c-api-for-delaunay-triangulation-in-opencv
    ...
    */
    ...
    static void paint_voronoi( Mat& img, Subdiv2D& subdiv )
    {
        ...
        for( size_t i = 0; i < facets.size(); i++ )
        {
            ...
            Scalar color;
            color[0] = arc4random() & 255;
            color[1] = arc4random() & 255;
            color[2] = arc4random() & 255;
    ...
    int main( int argc, char** argv )
    {
        ...
        for( int i = 0; i < 200; i++ )
        {
            Point2f fp( (float)(arc4random()%(rect.width-10)+5),
                        (float)(arc4random()%(rect.height-10)+5));
